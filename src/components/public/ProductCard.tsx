          ...
          <div className="flex items-center gap-2">
            {product.stock_qty > 0 && (
              <button
                ...
                className="flex-1 flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-semibold transition-all duration-200 hover:opacity-90 hover:shadow-sm active:scale-95 text-white"
                style={{ backgroundColor: 'var(--color-accent)' }}
              >
            ...
            <WhatsAppButton product={product} label="Devis" className="px-2.5 py-1.5 text-xs rounded-xl" />
            <WishlistButton product={product} size={16} className="rounded-xl" />
          </div>
        </div>
      </div>
    </Link>

...
export function PublicHeader() {
  ...
  return (
    <header
      ...
      style={{
        backgroundColor: isDarkMode ? 'var(--dark-bg)' : 'var(--color-bg)',
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-1">
            ...
            <Link
              to="/wishlist"
              className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${
                location.pathname === '/wishlist' ? 'font-semibold' : 'hover:opacity-80'
              }`}
              style={{
                color: location.pathname === '/wishlist' ? 'var(--color-primary)' : 'var(--color-text)',
                backgroundColor: location.pathname === '/wishlist' ? 'var(--color-primary)' + '15' : 'transparent',
              }}
            >
              Favoris
            </Link>
          ...
          <div className="flex items-center gap-1">
            ...
            <Link
              to="/wishlist"
              className="relative p-2 rounded-lg transition-colors hover:bg-black/5 hidden sm:flex"

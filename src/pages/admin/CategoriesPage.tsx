...
export function CategoriesPage() {
  ...
  const handleSave = async () => {
    ...
    if (editingCategory) {
      ...
      const after = { ...editingCategory, ...payload };
      await logActivityWithDiff(
        { action: 'update', entity_type: 'category', entity_id: editingCategory.id },
        editingCategory,
        after
      );
  ...
  return (
    <div className="p-6">
      ...
      <Modal isOpen={showModal} onClose={() => setShowModal(false)} title={editingCategory ? 'Modifier la catégorie' : 'Nouvelle catégorie'} size="md">
      ...
      <Modal isOpen={!!deleteId} onClose={() => setDeleteId(null)} title="Supprimer la catégorie" size="sm">

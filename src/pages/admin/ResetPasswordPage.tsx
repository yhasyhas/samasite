...
export function ResetPasswordPage() {
  ...
  // 1. Vérifier que l'utilisateur a une session active (Supabase parse le hash automatiquement)
  useEffect(() => {
    let cancelled = false;

    const verifySession = async () => {
      // Petit délai pour laisser Supabase parser le hash de l'URL
      ...
      if (session) {
        ...
        // Essayer avec exchangeCodeForSession si code PKCE présent
    ...
    return (
      <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
        <div className="w-full max-w-sm text-center">
          ...
          <h1 className="text-xl font-bold text-white mb-2">Mot de passe défini !</h1>
      ...
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-400 mt-1">
            Vous avez été invité à rejoindre l'équipe. Créez un mot de passe sécurisé pour accéder au tableau de bord.
          </p>
        </div>
